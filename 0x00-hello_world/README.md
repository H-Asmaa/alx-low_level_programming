...
<h6>DESCRIPTION</h6>
	<p>I couldn't believe when a friend told me that `sizeof` is not a function. I had always assumed that   anything with `()` is a function.`sizeof()` is an operator.<br>
